    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            myList.Add(car1);
            myList.Add(car2);
            // myList.Add(b1); // Error, can not convert from Book to Car
            ...
            */
            ...
            Dictionary<string, Car> myDictionay = new Dictionary<string, Car>();

            myDictionay.Add(car1.VIN, car1);
            myDictionay.Add(car2.VIN, car2);

            Console.WriteLine(myDictionay["B2"].Make);
            */
